...
hidden_figures = media.Movie("Hidden Figures", "Black women working on one of the greatest missions at NASA",
...
mummy = media.Movie('The Mummy', 'An ancient egyptian priest is accidently resurrected',
